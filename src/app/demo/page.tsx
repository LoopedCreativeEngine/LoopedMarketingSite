  ...
  return (
    <div className="bg-paper pb-24 pt-28 sm:pt-32">
      <div className="mx-auto max-w-3xl px-5 text-center sm:px-6 lg:px-8">
        <Reveal>
          <p className="kicker text-purple">Get started</p>
          <h1 className="mt-4 font-serif text-4xl tracking-tight text-ink sm:text-5xl">Book a demo</h1>
      ...
      <div className="mx-auto mt-12 max-w-3xl px-5 sm:px-6 lg:px-8">
        <Reveal>
          <div
            className="flex min-h-[520px] flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[rgba(15,23,42,0.20)] bg-stone p-8 text-center"
            data-calendly-placeholder
          >
            <p className="font-mono text-xs font-semibold leading-relaxed text-purple sm:text-sm">
