...
export function EvidenceSection(): React.ReactElement {
  return (
    <Panel tone="night" index="06" kicker="Evidence and outcomes">
      ...
      <Reveal className="mt-12">
        <p className="mb-5 kicker text-lavender">Evidence → Recommendation → Decision → Action → Response → Outcome → Learning</p>
